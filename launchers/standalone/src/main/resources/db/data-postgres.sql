...
insert into s2_user ("name", password, salt, display_name, email, is_admin) values ('admin','c3VwZXJzb25pY0BiaWNvbaELbOQ0+CXFQEPGt421WiN6rYLJG8aOPo6idYSLptoh','SBNJTRN+FjG7owHVrKtuew==','admin','admin@xx.com', 1);
